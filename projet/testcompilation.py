...
class Animal(Vivant):
     ...
     def __init__(self,position: pygame.Vector2, speed: pygame.Vector2,energie_min : int, energie_max: int, energie_init :int) ->None:
